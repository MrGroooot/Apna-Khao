  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      <button
        ...
        className="bg-[#25D366] hover:bg-[#20BA56] text-white pl-4.5 pr-5 py-3 rounded-full shadow-premium hover:shadow-premium-hover transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 group focus:outline-none relative overflow-hidden"
